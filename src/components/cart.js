...
import {createOrder,clearOrder} from "../actions/orderActions";
 ...
 class Cart extends Component{
    constructor(props){
        super(props);
        this.state={name:"",email:"",address:"",showCheckout:false,};//bydefault checkout is not shown
    }
    handleInput=(e)=>{
    ...
    render(){
        const{cartItems,order}=this.props;//from parent component accessing cart items
        return(
            <div>
                ...
                {this.state.showCheckout &&(
                    ...
                    <ul className="form-container">
                        ...
                        <input name="address" type="text" required onChange={this.handleInput}></input>  
                            ...
                            <button className="button primary" type="submit">Checkout</button></li></ul></form></div>
                            </Fade>
                )}
                </div>
                )}
